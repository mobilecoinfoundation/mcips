...
The <a href="0003-encrypted-memos.md#reference-level-explanation" website="proposals/encrypted-memos#reference-level-explanation">e_memo field</a> is an encrypted memo field on every MobileCoin TxOut.
