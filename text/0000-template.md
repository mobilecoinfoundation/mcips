...
[MCIP 3](https://github.com/mobilecoinfoundation/mcips/pull/3) added encrypted memo fields to `TxOut`s. Since that addition, a number of standard memo types have been added. This proposal adds three new, standard memo types. These new memo types, however, are customizable. This will allow client applications to implement their own uses for the encrypted memo field.
